...
public class TieBreakTest {
	...
	/*
	 * player should win tie break if he gets at least 7 points and 2 points
	 * more than his opponent
	 */
	@Test
	@Parameters({ "6,2,true", "8,3,true", "6,6,false" })
	public void player_should_win_if_he_respect_criteria(int playerOneScore, int playerTwoScore, boolean shouldWin)
		...
		this.tieBreak.setPlayerTieBreakScores(SECOND_PLAYER,
				new ArrayList<>(Collections.singletonList(playerTwoScore)));

		// WHEN
		this.tieBreak.scores(FIRST_PLAYER);

		// THEN
		Player winner = this.tieBreak.getWinner().orElse(new Player("nobody"));
